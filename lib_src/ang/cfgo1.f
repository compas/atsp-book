...
*
    ...
    7 FORMAT(A72)
    8 FORMAT(A3)
   22 FORMAT(// ' STATE  (WITH',I3,' CONFIGURATIONS):'/
     :          ' -------------------------------'/)
   23 FORMAT(/' THERE ARE',I3,' ORBITALS AS FOLLOWS:'//
     : 5X,21(1X,A3):/5X,21(1X,A3))
   25 FORMAT(/' CONFIGURATION',I3,' ( OCCUPIED ORBITALS=',I2,' ):'
     : ,5(1X,A3,'(',I2,')'))
   26 FORMAT(26X,' COUPLING SCHEME:',5(1X,4X,I1,A1,I1))
   27 FORMAT(54X,4(1X,4X,I1,A1,I1))
   28 FORMAT(/' THERE ARE',I3,' CLOSED SUBSHELLS COMMON TO ALL ',
