...
*
     ...
     :          J1QNRD(9,NCD)
*
    5 FORMAT(/' THE TRIAD OF QUANTUM NUMBERS OF SHELL',I3,
     : ' IN CONFIGURATION',I3,' IS NOT A RECOGNIZED SET')
   ...
   17 FORMAT(/' CONFIGURATION',I3,
     : ' INCLUDES A SHELL OF ANGULAR MOMENTUM L.GE.3',
     : ' WITH TOO MANY ELECTRONS')
   18 FORMAT(/' CONFIGURATION',I3,
     : ' HAS AN INCORRECT NUMBER OF ELECTRONS')
*
      IALLOW=1
      DO 1 I=1,NCFG
         NELSUM = 0
